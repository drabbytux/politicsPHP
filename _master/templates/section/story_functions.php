...
<div>
		<div class="TabbedPanelsHeading">
			<div class="TabbedPanelsHeadingContent">Share</div>
		</div>
		<div class="TabbedPanels" id="tp2" style="margin-bottom: 15px;">
			<ul class="TabbedPanelsTabGroup">
				<li class="TabbedPanelsTab" tabindex="0">Send</li>
				<li class="TabbedPanelsTab" tabindex="0">Bookmark</li>
				<!-- <li class="TabbedPanelsTab" tabindex="0">Blog</li>  -->
			</ul>
			<div class="TabbedPanelsContentGroup">
				<div class="TabbedPanelsContent">
					<form action="" method="POST" onSubmit="alert('This function will be active soon!'); return false;">
						<table>
							<tr><td>Email From: </td><td><input style="width: 210px;" type="text" /></td></tr>
							<tr><td>Email To: 	</td><td><input style="width: 210px;" type="text" /></td></tr>
							<tr><td>Message: 	</td><td><textarea style="width: 210px; height: 80px;"></textarea></td></tr>
							<tr><td colspan=2 style="text-align: right;"><input type="submit" name="submit_friend" value="Preview" style="font-size: 9pt;" /><input type="submit" name="submit_friend" value="Send it" style="font-size: 9pt;" /></td></tr>
						</table>
					</form>
				</div>
				<div class="TabbedPanelsContent">
						<script type="text/javascript">
									...
									<form id="myform" action="http://www.addthis.com/bookmark.php" method="post">
									<input type="hidden" id="mys" name="s" value="" />
									<input type="hidden" id="pub" name="pub" value="YOUR-ACCOUNT-ID" />
									<input type="hidden" id="url" name="url" value="http://<?=DOMAIN;?>/" />
									<input type="hidden" id="title" name="title" value="<?=DEFAULT_TITLE;?>" />
							...
							<div class="TabbedPanelsContent">
									SAMPLE: Mining Ombudsperson a Minimum<br />
									SAMPLE: Public Consular Cases Raise Red Flags<br />
									SAMPLE: Recognition of Kosovo Demonstrates Canada's Strong Support for Peace<br />
									SAMPLE: Kosovars Thank Canada<br />
									SAMPLE: Tom the Dancing Bug
							</div>
						</div>

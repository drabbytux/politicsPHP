...
//]]>--></script><noscript><a href='http://www.embassymag.ca/promotions/www/delivery/ck.php?n=ae14490e&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://www.embassymag.ca/promotions/www/delivery/avw.php?zoneid=7&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=ae14490e' border='0' alt='' /></a></noscript>
		 ...
		 <?
		  ...
		  // --- Embassy Production Banner ---
			  ...
			  if (@include_once(MAX_PATH . '/www/delivery/alocal.php')) {
			    ...
			    $phpAds_raw = view_local('', 7, 0, 0, '', '', '0', $phpAds_context, '');
			  }

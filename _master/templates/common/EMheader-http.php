...
<meta name="description" content="<?=$this->Get_Data('meta_description');?> Embassy - Canada's Foreign Policy Newspaper, covers politics and policy">
<meta name="keywords" content="<?=$this->Get_Data('meta_keywords');?> Defence, International trade, foreign safety, ambassadors, diplomates, treaties, lobbying, embassies, policy briefings, Ottawa parties, U.S.Canada relations, Chatter House, Canada newspaper, Parliament, Canadian news, committees, in-depth politics, foreign policy">
	...
	<div id="categorynav">
		<div class="content">
			<ul id="MenuBar1">
				...
				<li><a <?=( $this->Get_URL_Element( REQUEST_CONTROLLER )=='column' || ($this->Get_URL_Element( REQUEST_CONTROLLER )=='section' && $this->Get_URL_Element( REQUEST_ACTION )=='columns' ) )? 'class="selected"':NULL; ?> href="/section/columns">Columns</a></li>

 ...
 */
	...
	define('DB_NAME', 			'hilltimes_clean');
	...
	// URL
	define('URL_BASIC',			'clean.hilltimes.com');
	define('SERVER_URL',		'http://'.URL_BASIC);
	define('SECURE_SERVER_URL',	'https://secure.clean.hilltimes.com');
	
	// Secure Document Root - MUST BE EDITED FOR THE SERVER!!!!!!
	define('BASE_SECURE_FILES',	'/www/'.URL_BASIC.'/site_storage/');
